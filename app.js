...
var rawTransaction = { nonce: "0x0014", to: receivingAddress, gasPrice: '0x99990000', gasLimit: '0x30000', value: '0x9999929922710', data: "0x000" }
...
//web3.eth.getUncle(4, 0).then(console.log);
//web3.eth.getTransactionCount("0xe773a4ba0baebf712f90f19b02dde086a0642ec96d0a01ad1df1fc149bc0ca44").then(console.log);
